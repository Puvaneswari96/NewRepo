# -*- coding: utf-8 -*-
"""Copy of Brazilian_Ecommerce_Project.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1UjDuG8Jg_DGdTURU0_zXP2Rk5VvmbsJO
...
##                 E-Commerce Sales Prediction Using Machine Learning Approach

##                               Group Assignment (Part 2)

###                               GROUP 9 - Data Infinity

Team Members & Roles

-   Puvaneswari Poobalan (S2182524) - Leader (<https://sites.google.com/view/s2182524?usp=sharing>)
-   Chong Hun Yee (S2197999) - Data Scientist (<https://sites.google.com/view/chong-hun-yee>)
-   Ool Mei Ling (22064004) - Secretary (<https://sites.google.com/view/22064004?usp=sharing>)
-   Wang Chunli (22064827) - Machine Learning Engineer (<https://sites.google.com/view/wangchunli?usp=sharing>)
-   Meng Guan (S2179731) - Information Designer (<https://sites.google.com/view/eportfolio-s2179731?usp=sharing>)
...
### 4.1 Drop Unneccessary Features
"""
...
"""# 7.0 NLP For Customer Satisfaction"""
...
"""# 8.0 Customer Segmentation

### 8.1 Customer Segmentation by RFM Analysis
"""
...
#files.download('Clustering Sample.csv')
...
! streamlit run Brazilian_Ecommerce_Project.py & npx localtunnel --port 8501

"""# 10.0 Conclusion

#### 1- For future work, it is suggested to expand the scope of the project in order to include more recent datasets, including other relevant data sources which may improve the predictive power of models in this project.
#### 2- Furthermore, to make the model more general and adaptable to different e-commerce environments, the performance of the model can be evaluated using different data subsets, such as data from different industries, different regions, or different business scales.
#### 3- Finally we deploy Streamlit web App for EDA, Classification and Clustering providing the option to upload sample data and investigate it by the App.
"""